          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('%', Colors.red, Colors.black),
                calcbutton('/', Colors.red[700], Colors.black),
              ],
            ),
            SizedBox(
              height: 10,
            ...
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('x', Colors.red[700], Colors.white),
              ],
            ),
            SizedBox(
              height: 10,
            ...
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('-', Colors.red[700], Colors.white),
              ],
            ),
            SizedBox(
              height: 10,
            ...
            Row(
              ...
              children: <Widget>[
                //this is button Zero
                RaisedButton(
                  padding: EdgeInsets.fromLTRB(34, 0, 128, 20),
                  onPressed: () {
                    calculation('0');
                  },
                  shape: StadiumBorder(),
